...
#    link = "https://wolverdonfilme.net/um-chamado-de-esperanca-torrent-2022-dual-audio-dublado-web-dl-1080p-download-WF/"
#    photo = 'teste'
    ...
    img = str(soup.find_all('meta', attrs={'property':"og:image"})).replace('[<meta content="','').replace('" property="og:image:secure_url"/>]','').replace('i1.wp.com/','').replace('" property="og:image"/>]','')
